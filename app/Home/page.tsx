...
Welcome to the Portal
  ...
  <div className="grid md:grid-cols-2 sm:grid-cols-1 gap-4 w-full max-w-lg">
    ...
    //   <h1 className="text-2xl md:text-3xl font-bold text-gray-700 m-2 text-center">
    ...
    //         <span className="text-gray-800 font-medium text-sm md:text-lg">Admin Registration</span>
    //       </div>
    //       <span className="text-sm text-blue-500">Go &rarr;</span>
    //     </button>
    ...
    //     >
    //       <div className="flex items-center gap-3">
    //         <ArrowRightOnRectangleIcon className="w-6 h-6 text-purple-600" />
    //         <span className="text-gray-800 font-medium text-sm md:text-lg">Admin Login</span>
    //       </div>
    //       <span className="text-sm text-purple-500">Go &rarr;</span>
    //     </button>
    ...
    //         <span className="text-gray-800 font-medium text-sm md:text-lg">Employee Registration</span>
    //       </div>
    //       <span className="text-sm text-green-500">Go &rarr;</span>
    //     </button>
    ...
    //     >
    //       <div className="flex items-center gap-3">
    //         <ArrowLeftOnRectangleIcon className="w-6 h-6 text-orange-600" />
    //         <span className="text-gray-800 font-medium text-sm md:text-lg">Employee Login</span>
    //       </div>
    //       <span className="text-sm text-orange-500">Go &rarr;</span>
    //     </button>
